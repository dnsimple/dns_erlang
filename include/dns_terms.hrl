...
%% See RFC6605
-define(DNS_ALG_ECDSAP256SHA256_NUMBER, 13).
-define(DNS_ALG_ECDSAP256SHA256_BSTR, ~"ECDSAP256SHA256").
-define(DNS_ALG_ECDSAP256SHA256, ?DNS_ALG_ECDSAP256SHA256_NUMBER).

%% See RFC6605
-define(DNS_ALG_ECDSAP384SHA384_NUMBER, 14).
-define(DNS_ALG_ECDSAP384SHA384_BSTR, ~"ECDSAP384SHA384").
-define(DNS_ALG_ECDSAP384SHA384, ?DNS_ALG_ECDSAP384SHA384_NUMBER).

%% See RFC8080 and RFC9077
-define(DNS_ALG_ED25519_NUMBER, 15).
-define(DNS_ALG_ED25519_BSTR, ~"ED25519").
-define(DNS_ALG_ED25519, ?DNS_ALG_ED25519_NUMBER).

%% See RFC8080 and RFC9077
-define(DNS_ALG_ED448_NUMBER, 16).
-define(DNS_ALG_ED448_BSTR, ~"ED448").
-define(DNS_ALG_ED448, ?DNS_ALG_ED448_NUMBER).
...
-define(DNS_ZONEMD_ALG_SHA384_NUMBER, 1).
-define(DNS_ZONEMD_ALG_SHA384_BSTR, ~"SHA384").
-define(DNS_ZONEMD_ALG_SHA384, ?DNS_ZONEMD_ALG_SHA384_NUMBER).
-define(DNS_ZONEMD_ALG_SHA512_NUMBER, 2).
-define(DNS_ZONEMD_ALG_SHA512_BSTR, ~"SHA512").
-define(DNS_ZONEMD_ALG_SHA512, ?DNS_ZONEMD_ALG_SHA512_NUMBER).
...
-define(DNS_TYPE_SMIMEA_NUMBER, 53).
-define(DNS_TYPE_SMIMEA_BSTR, ~"SMIMEA").
-define(DNS_TYPE_SMIMEA, ?DNS_TYPE_SMIMEA_NUMBER).
...
-define(DNS_TYPE_OPENPGPKEY_NUMBER, 61).
-define(DNS_TYPE_OPENPGPKEY_BSTR, ~"OPENPGPKEY").
-define(DNS_TYPE_OPENPGPKEY, ?DNS_TYPE_OPENPGPKEY_NUMBER).
-define(DNS_TYPE_CSYNC_NUMBER, 62).
-define(DNS_TYPE_CSYNC_BSTR, ~"CSYNC").
-define(DNS_TYPE_CSYNC, ?DNS_TYPE_CSYNC_NUMBER).
-define(DNS_TYPE_ZONEMD_NUMBER, 63).
-define(DNS_TYPE_ZONEMD_BSTR, ~"ZONEMD").
-define(DNS_TYPE_ZONEMD, ?DNS_TYPE_ZONEMD_NUMBER).
...
-define(DNS_TYPE_DSYNC_NUMBER, 66).
-define(DNS_TYPE_DSYNC_BSTR, ~"DSYNC").
-define(DNS_TYPE_DSYNC, ?DNS_TYPE_DSYNC_NUMBER).
...
-define(DNS_TYPE_EUI48_NUMBER, 108).
-define(DNS_TYPE_EUI48_BSTR, ~"EUI48").
-define(DNS_TYPE_EUI48, ?DNS_TYPE_EUI48_NUMBER).
-define(DNS_TYPE_EUI64_NUMBER, 109).
-define(DNS_TYPE_EUI64_BSTR, ~"EUI64").
-define(DNS_TYPE_EUI64, ?DNS_TYPE_EUI64_NUMBER).
...
-define(DNS_TYPE_URI_NUMBER, 256).
-define(DNS_TYPE_URI_BSTR, ~"URI").
-define(DNS_TYPE_URI, ?DNS_TYPE_URI_NUMBER).
-define(DNS_TYPE_CAA_NUMBER, 257).
-define(DNS_TYPE_CAA_BSTR, ~"CAA").
-define(DNS_TYPE_CAA, ?DNS_TYPE_CAA_NUMBER).
-define(DNS_TYPE_RESINFO_NUMBER, 261).
-define(DNS_TYPE_RESINFO_BSTR, ~"RESINFO").
-define(DNS_TYPE_RESINFO, ?DNS_TYPE_RESINFO_NUMBER).
-define(DNS_TYPE_WALLET_NUMBER, 262).
-define(DNS_TYPE_WALLET_BSTR, ~"WALLET").
-define(DNS_TYPE_WALLET, ?DNS_TYPE_WALLET_NUMBER).
...
-define(DNS_OPCODE_DSO_NUMBER, 6).
-define(DNS_OPCODE_DSO_BSTR, ~"DSO").
-define(DNS_OPCODE_DSO, ?DNS_OPCODE_DSO_NUMBER).
...
-define(DNS_EOPTCODE_EDE_NUMBER, 15).
-define(DNS_EOPTCODE_EDE_BSTR, ~"EDE").
-define(DNS_EOPTCODE_EDE, ?DNS_EOPTCODE_EDE_NUMBER).

%% Extended DNS Error (EDE) INFO-CODE values. See RFC 8914: §5.2.
-define(DNS_EDE_OTHER_ERROR_NUMBER, 0).
-define(DNS_EDE_OTHER_ERROR_BSTR, ~"Other Error").
-define(DNS_EDE_OTHER_ERROR, ?DNS_EDE_OTHER_ERROR_NUMBER).
-define(DNS_EDE_UNSUPPORTED_DNSKEY_ALG_NUMBER, 1).
-define(DNS_EDE_UNSUPPORTED_DNSKEY_ALG_BSTR, ~"Unsupported DNSKEY Algorithm").
-define(DNS_EDE_UNSUPPORTED_DNSKEY_ALG, ?DNS_EDE_UNSUPPORTED_DNSKEY_ALG_NUMBER).
-define(DNS_EDE_UNSUPPORTED_DS_DIGEST_NUMBER, 2).
-define(DNS_EDE_UNSUPPORTED_DS_DIGEST_BSTR, ~"Unsupported DS Digest Type").
-define(DNS_EDE_UNSUPPORTED_DS_DIGEST, ?DNS_EDE_UNSUPPORTED_DS_DIGEST_NUMBER).
-define(DNS_EDE_STALE_ANSWER_NUMBER, 3).
-define(DNS_EDE_STALE_ANSWER_BSTR, ~"Stale Answer").
-define(DNS_EDE_STALE_ANSWER, ?DNS_EDE_STALE_ANSWER_NUMBER).
-define(DNS_EDE_FORGED_ANSWER_NUMBER, 4).
-define(DNS_EDE_FORGED_ANSWER_BSTR, ~"Forged Answer").
-define(DNS_EDE_FORGED_ANSWER, ?DNS_EDE_FORGED_ANSWER_NUMBER).
-define(DNS_EDE_DNSSEC_INDETERMINATE_NUMBER, 5).
-define(DNS_EDE_DNSSEC_INDETERMINATE_BSTR, ~"DNSSEC Indeterminate").
-define(DNS_EDE_DNSSEC_INDETERMINATE, ?DNS_EDE_DNSSEC_INDETERMINATE_NUMBER).
-define(DNS_EDE_DNSSEC_BOGUS_NUMBER, 6).
-define(DNS_EDE_DNSSEC_BOGUS_BSTR, ~"DNSSEC Bogus").
-define(DNS_EDE_DNSSEC_BOGUS, ?DNS_EDE_DNSSEC_BOGUS_NUMBER).
-define(DNS_EDE_SIGNATURE_EXPIRED_NUMBER, 7).
-define(DNS_EDE_SIGNATURE_EXPIRED_BSTR, ~"Signature Expired").
-define(DNS_EDE_SIGNATURE_EXPIRED, ?DNS_EDE_SIGNATURE_EXPIRED_NUMBER).
-define(DNS_EDE_SIGNATURE_NOT_YET_VALID_NUMBER, 8).
-define(DNS_EDE_SIGNATURE_NOT_YET_VALID_BSTR, ~"Signature Not Yet Valid").
-define(DNS_EDE_SIGNATURE_NOT_YET_VALID, ?DNS_EDE_SIGNATURE_NOT_YET_VALID_NUMBER).
-define(DNS_EDE_DNSKEY_MISSING_NUMBER, 9).
-define(DNS_EDE_DNSKEY_MISSING_BSTR, ~"DNSKEY Missing").
-define(DNS_EDE_DNSKEY_MISSING, ?DNS_EDE_DNSKEY_MISSING_NUMBER).
-define(DNS_EDE_RRSIGS_MISSING_NUMBER, 10).
-define(DNS_EDE_RRSIGS_MISSING_BSTR, ~"RRSIGs Missing").
-define(DNS_EDE_RRSIGS_MISSING, ?DNS_EDE_RRSIGS_MISSING_NUMBER).
-define(DNS_EDE_NO_ZONE_KEY_BIT_SET_NUMBER, 11).
-define(DNS_EDE_NO_ZONE_KEY_BIT_SET_BSTR, ~"No Zone Key Bit Set").
-define(DNS_EDE_NO_ZONE_KEY_BIT_SET, ?DNS_EDE_NO_ZONE_KEY_BIT_SET_NUMBER).
-define(DNS_EDE_NSEC_MISSING_NUMBER, 12).
-define(DNS_EDE_NSEC_MISSING_BSTR, ~"NSEC Missing").
-define(DNS_EDE_NSEC_MISSING, ?DNS_EDE_NSEC_MISSING_NUMBER).
-define(DNS_EDE_CACHED_ERROR_NUMBER, 13).
-define(DNS_EDE_CACHED_ERROR_BSTR, ~"Cached Error").
-define(DNS_EDE_CACHED_ERROR, ?DNS_EDE_CACHED_ERROR_NUMBER).
-define(DNS_EDE_NOT_READY_NUMBER, 14).
-define(DNS_EDE_NOT_READY_BSTR, ~"Not Ready").
-define(DNS_EDE_NOT_READY, ?DNS_EDE_NOT_READY_NUMBER).
-define(DNS_EDE_BLOCKED_NUMBER, 15).
-define(DNS_EDE_BLOCKED_BSTR, ~"Blocked").
-define(DNS_EDE_BLOCKED, ?DNS_EDE_BLOCKED_NUMBER).
-define(DNS_EDE_CENSORED_NUMBER, 16).
-define(DNS_EDE_CENSORED_BSTR, ~"Censored").
-define(DNS_EDE_CENSORED, ?DNS_EDE_CENSORED_NUMBER).
-define(DNS_EDE_FILTERED_NUMBER, 17).
-define(DNS_EDE_FILTERED_BSTR, ~"Filtered").
-define(DNS_EDE_FILTERED, ?DNS_EDE_FILTERED_NUMBER).
-define(DNS_EDE_PROHIBITED_NUMBER, 18).
-define(DNS_EDE_PROHIBITED_BSTR, ~"Prohibited").
-define(DNS_EDE_PROHIBITED, ?DNS_EDE_PROHIBITED_NUMBER).
-define(DNS_EDE_STALE_NXDOMAIN_ANSWER_NUMBER, 19).
-define(DNS_EDE_STALE_NXDOMAIN_ANSWER_BSTR, ~"Stale NXDomain Answer").
-define(DNS_EDE_STALE_NXDOMAIN_ANSWER, ?DNS_EDE_STALE_NXDOMAIN_ANSWER_NUMBER).
-define(DNS_EDE_NOT_AUTHORITATIVE_NUMBER, 20).
-define(DNS_EDE_NOT_AUTHORITATIVE_BSTR, ~"Not Authoritative").
-define(DNS_EDE_NOT_AUTHORITATIVE, ?DNS_EDE_NOT_AUTHORITATIVE_NUMBER).
-define(DNS_EDE_NOT_SUPPORTED_NUMBER, 21).
-define(DNS_EDE_NOT_SUPPORTED_BSTR, ~"Not Supported").
-define(DNS_EDE_NOT_SUPPORTED, ?DNS_EDE_NOT_SUPPORTED_NUMBER).
-define(DNS_EDE_NO_REACHABLE_AUTHORITY_NUMBER, 22).
-define(DNS_EDE_NO_REACHABLE_AUTHORITY_BSTR, ~"No Reachable Authority").
-define(DNS_EDE_NO_REACHABLE_AUTHORITY, ?DNS_EDE_NO_REACHABLE_AUTHORITY_NUMBER).
-define(DNS_EDE_NETWORK_ERROR_NUMBER, 23).
-define(DNS_EDE_NETWORK_ERROR_BSTR, ~"Network Error").
-define(DNS_EDE_NETWORK_ERROR, ?DNS_EDE_NETWORK_ERROR_NUMBER).
-define(DNS_EDE_INVALID_DATA_NUMBER, 24).
-define(DNS_EDE_INVALID_DATA_BSTR, ~"Invalid Data").
-define(DNS_EDE_INVALID_DATA, ?DNS_EDE_INVALID_DATA_NUMBER).
...
-define(DNS_SVCB_PARAM_ECH_NUMBER, 5).
-define(DNS_SVCB_PARAM_ECH_BSTR, ~"ech").
-define(DNS_SVCB_PARAM_ECH, ?DNS_SVCB_PARAM_ECH_NUMBER).
...
-define(DNS_SVCB_PARAM_DOHPATH_NUMBER, 7).
-define(DNS_SVCB_PARAM_DOHPATH_BSTR, ~"dohpath").
-define(DNS_SVCB_PARAM_DOHPATH, ?DNS_SVCB_PARAM_DOHPATH_NUMBER).
-define(DNS_SVCB_PARAM_OHTTP_NUMBER, 8).
-define(DNS_SVCB_PARAM_OHTTP_BSTR, ~"ohttp").
-define(DNS_SVCB_PARAM_OHTTP, ?DNS_SVCB_PARAM_OHTTP_NUMBER).
