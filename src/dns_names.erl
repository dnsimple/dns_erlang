...
type_name(Int) when is_integer(Int) ->
    case Int of
        ...
        ?DNS_TYPE_CSYNC_NUMBER -> ?DNS_TYPE_CSYNC_BSTR;
        ?DNS_TYPE_ZONEMD_NUMBER -> ?DNS_TYPE_ZONEMD_BSTR;
        ?DNS_TYPE_SVCB_NUMBER -> ?DNS_TYPE_SVCB_BSTR;
        ?DNS_TYPE_DSYNC_NUMBER -> ?DNS_TYPE_DSYNC_BSTR;
...
name_type(Bin) when is_binary(Bin) ->
    case Bin of
        ...
        ?DNS_TYPE_CSYNC_BSTR -> ?DNS_TYPE_CSYNC_NUMBER;
        ?DNS_TYPE_ZONEMD_BSTR -> ?DNS_TYPE_ZONEMD_NUMBER;
        ?DNS_TYPE_SVCB_BSTR -> ?DNS_TYPE_SVCB_NUMBER;
        ?DNS_TYPE_DSYNC_BSTR -> ?DNS_TYPE_DSYNC_NUMBER;
...
opcode_name(Int) when is_integer(Int) ->
    case Int of
        ...
        ?DNS_OPCODE_NOTIFY_NUMBER -> ?DNS_OPCODE_NOTIFY_BSTR;
        ?DNS_OPCODE_UPDATE_NUMBER -> ?DNS_OPCODE_UPDATE_BSTR;
        ?DNS_OPCODE_DSO_NUMBER -> ?DNS_OPCODE_DSO_BSTR;
        _ -> undefined
    end.
...
name_opcode(Bin) when is_binary(Bin) ->
    case Bin of
        ...
        ?DNS_OPCODE_NOTIFY_BSTR -> ?DNS_OPCODE_NOTIFY_NUMBER;
        ?DNS_OPCODE_UPDATE_BSTR -> ?DNS_OPCODE_UPDATE_NUMBER;
        ?DNS_OPCODE_DSO_BSTR -> ?DNS_OPCODE_DSO_NUMBER;
        _ -> undefined
    end.
