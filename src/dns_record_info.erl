...
fields(dns_rrdata_openpgpkey) -> record_info(fields, dns_rrdata_openpgpkey);
...
fields(dns_rrdata_eui48) -> record_info(fields, dns_rrdata_eui48);
fields(dns_rrdata_eui64) -> record_info(fields, dns_rrdata_eui64);
...
fields(dns_rrdata_csync) -> record_info(fields, dns_rrdata_csync);
fields(dns_rrdata_dsync) -> record_info(fields, dns_rrdata_dsync);
fields(dns_rrdata_tlsa) -> record_info(fields, dns_rrdata_tlsa);
fields(dns_rrdata_smimea) -> record_info(fields, dns_rrdata_smimea);
...
fields(dns_rrdata_svcb) -> record_info(fields, dns_rrdata_svcb);
fields(dns_rrdata_https) -> record_info(fields, dns_rrdata_https);
...
size(dns_rrdata_openpgpkey) -> record_info(size, dns_rrdata_openpgpkey);
...
size(dns_rrdata_eui48) -> record_info(size, dns_rrdata_eui48);
size(dns_rrdata_eui64) -> record_info(size, dns_rrdata_eui64);
...
size(dns_rrdata_csync) -> record_info(size, dns_rrdata_csync);
size(dns_rrdata_dsync) -> record_info(size, dns_rrdata_dsync);
size(dns_rrdata_tlsa) -> record_info(size, dns_rrdata_tlsa);
size(dns_rrdata_smimea) -> record_info(size, dns_rrdata_smimea);
...
size(dns_rrdata_svcb) -> record_info(size, dns_rrdata_svcb);
size(dns_rrdata_https) -> record_info(size, dns_rrdata_https);
...
atom_for_type(?DNS_TYPE_OPENPGPKEY) -> dns_rrdata_openpgpkey;
...
atom_for_type(?DNS_TYPE_CSYNC) -> dns_rrdata_csync;
atom_for_type(?DNS_TYPE_DSYNC) -> dns_rrdata_dsync;
atom_for_type(?DNS_TYPE_TLSA) -> dns_rrdata_tlsa;
atom_for_type(?DNS_TYPE_SMIMEA) -> dns_rrdata_smimea;
...
atom_for_type(?DNS_TYPE_SVCB) -> dns_rrdata_svcb;
atom_for_type(?DNS_TYPE_HTTPS) -> dns_rrdata_https;
atom_for_type(?DNS_TYPE_NAPTR) -> dns_rrdata_naptr;
atom_for_type(?DNS_TYPE_DS) -> dns_rrdata_ds;
atom_for_type(?DNS_TYPE_EUI48) -> dns_rrdata_eui48;
atom_for_type(?DNS_TYPE_EUI64) -> dns_rrdata_eui64;
...
type_for_atom(dns_rrdata_openpgpkey) -> ?DNS_TYPE_OPENPGPKEY;
...
type_for_atom(dns_rrdata_csync) -> ?DNS_TYPE_CSYNC;
type_for_atom(dns_rrdata_dsync) -> ?DNS_TYPE_DSYNC;
type_for_atom(dns_rrdata_tlsa) -> ?DNS_TYPE_TLSA;
type_for_atom(dns_rrdata_smimea) -> ?DNS_TYPE_SMIMEA;
...
type_for_atom(dns_rrdata_svcb) -> ?DNS_TYPE_SVCB;
type_for_atom(dns_rrdata_https) -> ?DNS_TYPE_HTTPS;
type_for_atom(dns_rrdata_naptr) -> ?DNS_TYPE_NAPTR;
type_for_atom(dns_rrdata_ds) -> ?DNS_TYPE_DS;
type_for_atom(dns_rrdata_eui48) -> ?DNS_TYPE_EUI48;
type_for_atom(dns_rrdata_eui64) -> ?DNS_TYPE_EUI64;
